...
export default class ListeContact extends React.Component {
    state = {
        contact: [],
        list: [],
        envoie: []
    ...
    render() {
        ...
        return (
            <View>
                <Button title='Permission requise' onPress={this.Permission} />
                <MultiSelect
                    ...
                    selectText="Choisir parmi vos contacts"
                ...
                />
                <Button title='AJOUTER' onPress={this.Envoie} />
            </View>
        );
    }
}
